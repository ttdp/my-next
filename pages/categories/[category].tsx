  ...
  return (
    <>
      ...
      <main>
        <h1>{title}</h1>
        <Alert>
          This page uses <strong>getStaticProps</strong> for high page loading speed and <strong>incremental static regeneration</strong> to show data not older than <strong>5 minutes</strong>.
        </Alert>
